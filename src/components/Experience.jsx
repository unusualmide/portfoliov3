    ...
    <div className="pt-4">
      ...
      <ul className="grid w-full grid-flow-row grid-cols-1 px-3 sm:grid-cols-2 sm:px-28 pt-14 gap-y-10 sm:gap-x-10">
        ...
        <li className="flex flex-row w-full gap-5 p-5 transition duration-500 h-80 bg-exp-color hover:bg-white/10">
          ...
          <div className="flex flex-col items-start justify-end gap-3 ">
            <h3 className="text-lg text-white">Frontend Developer</h3>
            <p className="text-sm text-white">CodSoft - <span className="font-extralight text-xs">Internship</span></p>
            <p className="text-sm text-hover-text">Developed and designed UI for a landing page of customer's health and </p>
          </div>
        </li>
        </Reveal>
      </ul>
